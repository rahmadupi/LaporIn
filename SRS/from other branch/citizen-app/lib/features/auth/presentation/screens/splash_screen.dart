...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Future<void> _decideNextRoute() async {
    // ============================================================
    // 🐛 DEBUG BYPASS LOGIN — HAPUS BLOK INI UNTUK MEMULIHKAN AUTH
    // Langsung masuk sebagai Citizen agar UI bisa dieksplorasi
    // tanpa harus login. Mudah di-revert: tinggal hapus blok ini.
    // ============================================================
    await Future.delayed(const Duration(milliseconds: 500));
    if (!mounted) return;
    Navigator.of(context).pushReplacementNamed(AppRoutes.citizenHome);
    return;
    // ============================================================

    // ⚠️ Kode asli di bawah — di-skip sementara oleh bypass di atas.
