...
/// Halaman Profil Warga. UI identik dengan admin/officer profile — dibuat
/// file terpisah per role karena tiap workspace berdiri sendiri.
...
class _CitizenProfileScreenState extends ConsumerState<CitizenProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        _ProfileHeader(name: user?.fullName ?? 'Warga'),
